...
{% include figure image_path="/images/blog/ConfFedProto/federated-learning.png" 
   alt="Federated Learning Process" 
   caption="Figure 1: Federated learning training process."
   class="center"
   width="400px"
%}
...
{% include figure image_path="/images/blog/ConfFedProto/Prototypes.png" 
   alt="Confidence-Weighted Prototype Creation" 
   caption="Figure 2: Confidence-Weighted Prototype Creation showing the embedding layer, feature extraction, and decision layers."
   class="center"
   width="400px"
%}
...
{% include figure image_path="/images/blog/ConfFedProto/overview.png" 
   alt="ConfFedProto Framework Overview" 
   caption="Figure 3: An overview of the ConfFedProto framework, showcasing the process of local prototype creation, global aggregation, and iterative model refinement."
   class="center"
   width="400px"
%}
...
{% include figure image_path="/images/blog/ConfFedProto/Visualization.png" 
   alt="Evolution of test set embeddings" 
   caption="Figure 4: Evolution of test set embeddings during training across global rounds (0, 5, 20, and 45). ConfFedProto enables tighter clustering of representations, showcasing its effectiveness in handling data heterogeneity."
   class="center"
   width="400px"
%}
