...
{% include figure image_path="/images/blog/ConfFedProto/federated-learning.png" caption="*Figure 1: Federated learning training process.*" alt="Federated Learning Process" class="align-center" %}
...
{% include figure image_path="/images/blog/ConfFedProto/Prototypes.png" caption="*Figure 2: Confidence-Weighted Prototype Creation.*" alt="Confidence-Weighted Prototype Creation" class="align-center" %}
...
{% include figure image_path="/images/blog/ConfFedProto/overview.png" caption="*Figure 3: An overview of the ConfFedProto framework, showcasing the process of local prototype creation and global aggregation.*" alt="ConfFedProto Framework Overview" class="align-center" %}
...
{% include figure image_path="/images/blog/ConfFedProto/Visualization.png" caption="*Figure 4: Evolution of test set embeddings during training across global rounds (0, 5, 20, and 45).*" alt="Evolution of test set embeddings" class="align-center" %}
