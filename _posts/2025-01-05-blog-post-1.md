...
<div style="text-align: center; margin: 20px auto; max-width: 500px;">
    <img src="/images/blog/ConfFedProto/Prototypes.png" alt="Confidence-Weighted Prototype Creation" style="width: 100%; height: auto;"/>
    <div style="font-size: 0.9em; color: #666; margin-top: 10px; font-style: italic;">
        Figure 2: Confidence-Weighted Prototype Creation showing the embedding layer, feature extraction, and decision layers.
    </div>
</div>
...
<div style="text-align: center; margin: 20px auto; max-width: 500px;">
    <img src="/images/blog/ConfFedProto/overview.png" alt="ConfFedProto Framework Overview" style="width: 100%; height: auto;"/>
    <div style="font-size: 0.9em; color: #666; margin-top: 10px; font-style: italic;">
...
<div style="text-align: center; margin: 20px auto; max-width: 500px;">
    <img src="/images/blog/ConfFedProto/Visualization.png" alt="Evolution of test set embeddings" style="width: 100%; height: auto;"/>
    <div style="font-size: 0.9em; color: #666; margin-top: 10px; font-style: italic;">
        Figure 4: Evolution of test set embeddings during training across global rounds (0, 5, 20, and 45). ConfFedProto enables tighter clustering of representations, showcasing its effectiveness in handling data heterogeneity.
    </div>
</div>
