...
{% include figure image_path="/images/blog/ConfFedProto/federated-learning.png" alt="Federated Learning Process" width="600px" caption="Figure 1: Federated learning training process." %}
...
{% include figure image_path="/images/blog/ConfFedProto/Prototypes.png" alt="Confidence-Weighted Prototype Creation" caption="Figure 2: Confidence-Weighted Prototype Creation showing the embedding layer, feature extraction, and decision layers." %}
...
{% include figure image_path="/images/blog/ConfFedProto/overview.png" alt="ConfFedProto Framework Overview" caption="Figure 3: An overview of the ConfFedProto framework, showcasing the process of local prototype creation, global aggregation, and iterative model refinement." %}
...
{% include figure image_path="/images/blog/ConfFedProto/Visualization.png" alt="Evolution of test set embeddings" width="600px" caption="Figure 4: Evolution of test set embeddings during training across global rounds (0, 5, 20, and 45). ConfFedProto enables tighter clustering of representations, showcasing its effectiveness in handling data heterogeneity." %}
